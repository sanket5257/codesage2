              ...
              <div className="row px-1 position-relative">
                <div className="col-lg-8 text-lg-start mb-md-30">
                  <p className="mb-0 opacity-8">
                    We specialize in a range of services that include software development,
                    cloud solutions, AI/ML integration, and digital transformation.
                  </p>
                </div>
